...
if (!$conn->connect_error) {
    ...
    $program = "Milk Processing"; // You can change this depending on the page
...
<head>
  <meta charset="UTF-8" />
  <title>Milk Processing – AERO DAIRY</title>
  ...
  <style>
    *{margin:0;padding:0;box-sizing:border-box}
    ...
    .navbar a{
      color:#fff;padding:14px 20px;font-weight:bold;text-decoration:none;
      transition:background .3s;
    }
    .navbar a:hover,
    .navbar a.active{background:rgba(255,255,255,.2)}
    ...
    .header-banner p{
      font-size:20px;max-width:820px;margin:12px auto 0;
    }

    /* BACK BUTTON */
    .back-btn{
      display:inline-block;margin:28px auto 0;padding:10px 26px;
      background:#00695c;border:none;border-radius:8px;
      font-size:16px;font-weight:600;color:#fff;cursor:pointer;
      transition:background .3s,transform .3s;
    }
    .back-btn:before{content:"← ";}
    .back-btn:hover{background:#00a88e;transform:scale(1.05)}

    /* CARD */
    .card{
      max-width:940px;margin:40px auto 60px;
    ...
    .card h2{
      background:#2e7d32;
      padding:18px 24px;font-size:26px;
    }
    ...
    /* APPLY BUTTON */
    .apply-btn{
      display:inline-block;margin:30px auto 38px;padding:12px 36px;
      background:linear-gradient(135deg,#2e7d32,#732bff);
      border:none;border-radius:9px;font-size:19px;color:#fff;cursor:pointer;
    ...
    /* FOOTER */
    footer{
      margin-top:auto;background:rgba(0,0,0,.85);
      font-size:14px;padding:14px;color:#fff;
    }
...
<header class="header-banner">
  <h1 class="glow-title">Milk Processing</h1>
  <p>Transform raw milk into high-quality dairy products using hygienic, safe, and modern techniques.</p>
</header>
...
<article class="card">
  ...
  <section>
    <h3>Overview</h3>
    <p>Explore the science and technology behind milk handling, pasteurization, and turning raw milk into consumer-ready dairy products.</p>
  </section>

  <section>
    <h3>Learning Outcomes</h3>
    <ul>
      <li>Understand milk properties and processing standards.</li>
      <li>Operate pasteurization and homogenization units.</li>
      <li>Monitor quality and microbial safety.</li>
      <li>Create new dairy product lines like yogurt and cheese.</li>
    </ul>
  </section>
  ...
  <section>
    ...
    <ul>
      <li>Milk Composition & Testing</li>
      <li>Thermal Processing & Pasteurization</li>
      <li>Fermentation & Product Innovation</li>
      <li>Hygiene, Safety & Regulatory Compliance</li>
    </ul>
  </section>

  <section>
    <h3>Practical Activities</h3>
    <p>Hands-on practice in milk processing labs: students produce and test milk products, track safety compliance, and simulate real-world processing operations.</p>
  </section>

  <section>
    <h3>Career Opportunities</h3>
    <p>Dairy technician, food safety analyst, plant supervisor, or quality control officer in cooperatives, factories, or export firms.</p>
  </section>
