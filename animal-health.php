...
if (!$conn->connect_error) {
    ...
    $program = "Animal Health"; // You can change this depending on the page
...
<head>
  <meta charset="UTF-8" />
  <title>Animal Health – AERO DAIRY</title>
  ...
  <style>
    ...
    * {
    ...
    html, body {
      ...
      background: url('perky.jpeg') no-repeat center center fixed;
...
<body>
  ...
  <main>
    <header>
      <h1><i class="fas fa-notes-medical"></i> Animal Health</h1>
...
<<a href="veterinary.html" class="focus-card">
  <i class="fas fa-stethoscope"></i> 1. Veterinary Practices
</a>
        <a href="vaccination.html" class="focus-card">
          <i class="fas fa-syringe"></i> 2. Vaccination & Disease Control
        </a>
        <a href="hygiene.html" class="focus-card">
          <i class="fas fa-broom"></i> 3. Hygiene & Housing
        </a>
        <a href="nutrition.html" class="focus-card">
          <i class="fas fa-apple-alt"></i> 4. Nutrition & Supplements
        </a>
      </div>

      <a href="programs.html" class="back-button"><i class="fas fa-arrow-left"></i> Back to Programs</a>
    </div>
  </main>
